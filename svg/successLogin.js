...
function SvgComponent(props) {
  return (
    ...
    >
      ...
      <Path fill="#008b91" opacity={0.2} d="M69 0h731v731H69z" />
      <Path fill="#008b91" opacity={0.5} d="M179 68.25h510v595.5H179z" />
      <Path fill="url(#prefix__a)" d="M595 105h273v525H595z" />
      <Path fill="url(#prefix__c)" d="M0 107h273v525H0z" />
      <Path fill="#008b91" d="M604 113h255v506H604zM264 619H9V113h255z" />
      <Path fill="url(#prefix__b)" d="M51 159h171v31H51z" />
      <Path fill="url(#prefix__d)" d="M647 206h171v31H647z" />
      <Path fill="url(#prefix__e)" d="M646 254h171v31H646z" />
      <Path fill="url(#prefix__f)" d="M646 302h171v31H646z" />
      <Path fill="url(#prefix__g)" d="M646 350h171v31H646z" />
      <Path fill="url(#prefix__h)" d="M646 398h171v31H646z" />
      <Path fill="url(#prefix__i)" d="M646 446h171v31H646z" />
      <Path fill="url(#prefix__j)" d="M646 494h171v31H646z" />
      <Path fill="url(#prefix__k)" d="M646 542h171v31H646z" />
      <Path fill="url(#prefix__l)" d="M646 159h171v31H646z" />
      <Path fill="url(#prefix__m)" d="M51 208h171v31H51z" />
      <Path fill="url(#prefix__n)" d="M51 255h171v31H51z" />
      <Path fill="url(#prefix__o)" d="M51 302h171v31H51z" />
      <Path fill="url(#prefix__p)" d="M51 350h171v31H51z" />
      <Path fill="url(#prefix__q)" d="M51 398h171v31H51z" />
      <Path
        fill="#fff"
      ...
      />
      <Path fill="url(#prefix__r)" d="M51 446h171v31H51z" />
      <Path fill="#fff" d="M54.5 450h164v24h-164z" />
      <Path
        fill="#fff"
      ...
      />
      <Path fill="url(#prefix__s)" d="M132 645h603v38H132z" />
      <Path fill="#008b91" d="M137 649h594v30H137z" />
      <Path fill="url(#prefix__t)" d="M134 50h602v39H134z" />
      <Path fill="#008b91" d="M137 53h594v30H137z" />
      <Path fill="#263238" opacity={0.5} d="M289 113h292v506H289z" />
      <Path
      ...
      <G opacity={0.2} fill="#fff">
        <Path d="M462.29 342.77c-.48 2.76-2.8 4.76-4.28 7.14-3.37 5.38-1.62 13.16 3.32 17a12.79 12.79 0 01.85-11.14c1.49-2.37 3.81-4.38 4.28-7.14.54-3.13-1.41-5.73-4.13-7.6a6 6 0 01-.04 1.74zM441.46 362.01c-.32-.75-.62-1.51-.88-2.27-.54-1.59-1.37-3.54-3.05-3.59a3.42 3.42 0 00-1.47.38 12 12 0 00-7 11.75 10.53 10.53 0 004.47 7.35 9.4 9.4 0 01-.3-1.51 12 12 0 017-11.75 3.87 3.87 0 011.23-.36zM434.41 377.85c-12.16.51-31.78-4.13-41.45-14 7.22 15.36 37.05 21.79 50 19.32a10.08 10.08 0 01-8.55-5.32zM462.68 369.61c-2.92 3.43-8.58 4.15-12.75 2.12a14.54 14.54 0 01-3.7-2.61 17.84 17.84 0 007.87 8.44c4.68 2.27 11.22 1.11 13.69-3.47a11.88 11.88 0 01-5.11-4.48z" />
      </G>
      <Path
        d="M671.85 369.27S551.76 562.75 500 572.76a60.33 60.33 0 01-9.07 1.11 53.05 53.05 0 0012.41-1.11c51.71-10 171.8-203.49 171.8-203.49l-2.68-.95c-.37.63-.61.95-.61.95zM198.15 369.27S318.24 562.75 370 572.76a60.33 60.33 0 009.07 1.11 53.05 53.05 0 01-12.41-1.11c-51.71-10-171.8-203.49-171.8-203.49l2.68-.95c.37.63.61.95.61.95z"
        fill="#fff"
        opacity={0.2}
      />
      <Path
      ...
      />
      <Path
        d="M435.83 507.3a80.93 80.93 0 00-8.72.47c1 0 1.91-.06 2.88-.06a80.06 80.06 0 0180.06 80.06v32.94h5.84v-33.35a80.06 80.06 0 00-80.06-80.06z"
        fill="#fff"
        opacity={0.2}
      />
      <Path
        d="M434.17 507.3a80.93 80.93 0 018.72.47c-1 0-1.91-.06-2.88-.06a80.06 80.06 0 00-80.06 80.06v32.94h-5.84v-33.35a80.06 80.06 0 0180.06-80.06z"
        fill="#fff"
        opacity={0.2}
      />
      <Rect
